...
foreach($hobbies1 as $chk1)
   ...
   if (move_uploaded_file($_FILES['profile']['tmp_name'], $target)) {
     $sql="INSERT INTO users (first_name, last_name, hobbies, gender, profile) VALUES ('".$fisrtName."','".$lastName."', '".$hobbies."', '".$gender."', '".$image."')";
...
<form action="#" id="form1" name="action" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group mb-3">
    ...
    <input type="file" class="form-control-file" id="file" name="profile" accept=".png"  onchange="validateFileType()">
      <label for="profile" class="error" id="usize" style="display:none;">Max Upload Size 5MB</label>
